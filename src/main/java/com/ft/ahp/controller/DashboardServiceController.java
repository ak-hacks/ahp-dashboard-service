...
public class DashboardServiceController {
	...
	/**
	 * Returns the list and metadata, as defined by the {@link com.ft.ahp.model.PrjBuildLife}
	 ...
	 * {@link com.ft.ahp.model.ProjectStatus} model object given a programme name
	 * 
	 * @param name
	 * @return
	 */
