...
/**
 * Adaptor for object serialisation into JSON
 * 
 * @author anurag.kapur
 */
public class BuildLifeAdapter implements JsonSerializer<BuildLife> {
	...
	public JsonElement serialize(BuildLife buildLife, Type type,
		...
		jsonObject.addProperty("latestStampValue",
				buildLife.getLatestStampValue());
		jsonObject.addProperty("actualWorkspaceDate", buildLife
				.getActualWorkspaceDate().toString());
		return jsonObject;
	}
